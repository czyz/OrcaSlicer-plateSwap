...
static std::set<std::string> gcodes_key_set =  {"filament_end_gcode", "filament_start_gcode", "change_filament_gcode", "layer_change_gcode", "plate_change_gcode", "machine_end_gcode", "machine_pause_gcode", "machine_start_gcode",
