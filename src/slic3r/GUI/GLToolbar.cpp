...
wxDEFINE_EVENT(EVT_GLTOOLBAR_PRINT_ALL_PLATE_CHANGER, SimpleEvent);
wxDEFINE_EVENT(EVT_GLTOOLBAR_SEND_TO_PRINTER_ALL_PLATE_CHANGER, SimpleEvent);
wxDEFINE_EVENT(EVT_GLTOOLBAR_EXPORT_ALL_SLICED_FILE_PLATE_CHANGER, SimpleEvent);
